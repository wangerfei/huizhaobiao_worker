...
public class POITest2 {
    ...
    public static void main(String[] args) throws Exception {
        ...
        HashMap<String,String> parentContent=new HashMap<String,String>();
        parentContent.put("title","大标题");

        Map<String,HashMap<String,String>> Content_page=new HashMap<String,HashMap<String,String>>();
        HashMap<String,String> Content=new HashMap<String,String>();
        Content.put("title","标题");
        Content.put("bdcode","编号");
        Content.put("bdname","标段");
        Content.put("pwhcy","王兆");
        Content_page.put("#compare",Content);
        ...
        tableContent.put("#compare11",table1);

    POIUtil3.createContent("G:\\BaiduNetdiskDownload\\ihrm_parent\\huizhaobiao_worker\\src\\main\\resources\\zonghe.docx",
                "G:\\BaiduNetdiskDownload\\ihrm_parent\\huizhaobiao_worker\\src\\main\\resources\\pbtable.docx",
                "G:\\BaiduNetdiskDownload\\ihrm_parent\\huizhaobiao_worker\\src\\main\\resources\\out_test16.docx",
                parentContent,Content_page,tableContent);
    ...
    public void testStoryExample() throws Exception{
         ...
         System.out.println( POIUtil3.getContent("G:\\BaiduNetdiskDownload\\ihrm_parent\\huizhaobiao_worker\\src\\main\\resources\\out.docx"));
     }
